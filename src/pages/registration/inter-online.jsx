...
export default function InternationalOnline() {
  ...
  const handleCategoryChange = (e) => {
    ...
    switch (value) {
      case "World Economics Challenge and Competition - Online Competition":
        ...
        break;
      case "World Economics Challenge and Competition - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)":
        setCategoryPrice("$225 USD");
        break;
      case "World Economics Challenge and Competition - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)":
  ...
  const scriptURL =
    "https://script.google.com/macros/s/AKfycbwzSt976vxbkSWM3VOIYm7vm-Sws1ZFanfwGWwmrj1wnKgzkxZijzVljh4bup0Xs9Qu/exec";
      ...
      <section className="registration-section">
              <div className="container">
                <div className="content">
                  ...
                  <br />
                  <h4>
                    HELLO WECC 2026 INTERNATIONAL CITIZEN, Please consider the
                    ...
                    <div className="user-details">
                      ...
                      <div className="input-box">
                        ...
                        >
                          ...
                          <option value="World Economics Challenge and Competition - Online Competition">
                            Online Competition
                          </option>
                          <option value="World Economics Challenge and Competition - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)">
                            Online Competition + Certificate and Medal (SOUTH EAST
                            ASIA)
                          </option>
                          <option value="World Economics Challenge and Competition - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)">
                    ...
                    <div className="user-details">
                      <div className="input-box">
                        ...
                        <label>
                          ...
                          <h6>Eki Iman Nasution</h6>
                          <h6>Prasetya Zaidan</h6>
                        </label>
                        <textarea
                          type="text"
                          id="NAMA_LENGKAP"
                    ...
                    <div className="user-details">
                      ...
                      <div className="input-box">
                        ...
                        >
                          ...
                          <option value="WECC Instagram">WECC Instagram</option>
