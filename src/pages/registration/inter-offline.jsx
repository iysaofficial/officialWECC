...
export default function InternationalOffline() {
  ...
  useEffect(() => {
    ...
    if (!termsAccepted) {
      ...
      navigate("/homeinter"); // Navigate to HomeIndo page
    }
  }, [navigate]);

  const scriptURL =
    "https://script.google.com/macros/s/AKfycbx3cspDRiYMeT8r1Y9xDZwL6eZ7oPulRPACvNkE1WnwkcQ8Zn3AfySSt30NbNsNWGRC/exec";
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="World Economics Challenge and Competition - Offline Competition + Full Package">
