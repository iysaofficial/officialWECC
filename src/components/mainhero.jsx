            ...
            <div className="row justify-content-md-center">
              <div className="content col-12 col-lg-9 col-xl-7 col-xxl-6 text-center">
                ...
                <div className="d-grid gap-2 d-sm-flex justify-content-sm-center">
                  ...
                  <a href="https://drive.google.com/drive/folders/1kGCLARfqUwZeXH4hUuddl2894oaDg4gL?usp=sharing" target="_blank" rel="noopener noreferrer" type="button" className="btn btn-outline-light btn-lg px-4">Guide book</a>
                </div>
              </div>
            </div>
          </div>
